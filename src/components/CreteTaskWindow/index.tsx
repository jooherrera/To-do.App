    ...
    <>
      <div className="CreateTaskWindow">
        ...
        <div className="CTW-Input mx-5 ">
          <Input placeholder="Add new task. [Min 5 letters]" isSearch={false} />
        </div>

        <button
          type="button"
          className="btn btn-success d-flex align-items-center justify-content-center mt-4 btnWeb "
          onClick={handToast}
        ...
        <button
          type="button"
          className="btn btn-success mt-4 btnMobile "
          onClick={handToast}
          disabled={loading || inputValue!.length <= 5}
          id="liveToastBtn"
          data-bs-dismiss="modal">
